...
![Use-case map — who does what, and which actions run an agent workflow (blue) vs. sit with a human (amber)](https://raw.githubusercontent.com/mkiselyow/ReviewOps-Agent/main/docs/media/use-case-map.png)
...
![End-to-end lifecycle — collect → evidence → review, with the human gates, confidence routing, and quality loops](https://raw.githubusercontent.com/mkiselyow/ReviewOps-Agent/main/docs/media/activity-lifecycle.png)

## What it looks like

![Generated skill-matrix questionnaire — safety verdict, shared L1–L5 legend, sections](https://raw.githubusercontent.com/mkiselyow/ReviewOps-Agent/main/docs/media/03-questionnaire-matrix-preview.png)

![Evidence validation — weak answers get a quality score, a follow-up question, and missing-detail hints](https://raw.githubusercontent.com/mkiselyow/ReviewOps-Agent/main/docs/media/04-survey-weak-followups.png)

![Review draft — privacy-filter categories, evidence-id citations, role-expectation coverage, fairness flags](https://raw.githubusercontent.com/mkiselyow/ReviewOps-Agent/main/docs/media/09-review-draft.png)
...
![System architecture](https://raw.githubusercontent.com/mkiselyow/ReviewOps-Agent/main/docs/media/architecture-detailed.png)
...
[`ARCHITECTURE.md`](https://github.com/mkiselyow/ReviewOps-Agent/blob/main/docs/ARCHITECTURE.md).
...
![Agent workflows](https://raw.githubusercontent.com/mkiselyow/ReviewOps-Agent/main/docs/media/agent-workflows.png)
...
![Review request sequence — permission assert, consent-gated context, privacy filter, pre-LLM security node, then Gemini, then save + audit](https://raw.githubusercontent.com/mkiselyow/ReviewOps-Agent/main/docs/media/review-sequence.png)
...
[`DEPLOY.md`](https://github.com/mkiselyow/ReviewOps-Agent/blob/main/docs/DEPLOY.md).
